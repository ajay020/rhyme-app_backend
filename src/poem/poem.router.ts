...
poemRouter.post("/", protect, async (req: Request, res: Response) => {
  try {
...
poemRouter.put("/:id", protect, async (req: Request, res: Response) => {
  try {
...
poemRouter.delete("/:id", protect, async (req: Request, res: Response) => {
  try {
